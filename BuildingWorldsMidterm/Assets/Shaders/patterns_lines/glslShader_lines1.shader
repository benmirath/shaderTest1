Shader "Unlit/glslShader_lines1"
{
	Properties {
		_Color1 ("Color", Color) = (0.075,0.114,0.329, 1.0)
		_Color2 ("Color", Color) = (0.973,0.843,0.675, 1.0)
...
//				    float time_anim1 = time * 5.;
					float time_anim1 = pulse (st, vec2 (st.x, 0.), 0., _AnimSpeedY);
//				    float time_scroll1 = time * _AnimSpeed;
...
//				    st.x -= time_scroll1;
				    ...
				    col = mix(_Color1, _Color2, circlePattern(grid1, 0.75 + (sin (time_anim1) * .3), 0.10 + (cos (time_anim1) * .05)));
