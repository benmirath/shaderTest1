Shader "Unlit/glslShader_square2"
{
	Properties {
	...
	SubShader {
      ...
      GLSLPROGRAM // here begins the part in Unity's GLSL
				...
				void main() {
				    ...
				    col = mix(_Color1, _Color2, boxPattern(grid1, vec2 (0.75)));
				    ...
				    col = mix(col, _Color3, boxPattern(grid2, vec2 (0.75)));
